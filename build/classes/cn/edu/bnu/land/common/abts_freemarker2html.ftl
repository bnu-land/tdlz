...
<body> 　　  
<table>  
<tr><td>图斑编号:</td><td>${dkTbid!"无"}</td></tr> 
<tr><td>图斑面积:</td><td>${dkArea!"无"}</td></tr> 
<tr><td>项目编号:</td><td>${projectId!"无"}</td></tr> 
<tr><td>项目名称:</td><td>${projectName!"无"}</td></tr> 
<tr><td>座落单位名称,对应行政单位名称:</td><td>${zldwmc!"无"}</td></tr> 
<tr><td>地类名称:</td><td>${dlmc!"无"}</td></tr> 
<tr><td>行政区代码:</td><td>${areaCode!"无"}</td></tr> 
...
<tr><td>是否预警:</td><td>${abdkIswarning!"无"}</td></tr> 
<tr><td>是否异常:</td><td>${abdkIsnormal!"无"}</td></tr> 
<tr><td>预警异常后风险等级:</td><td>${abdkRisklevel!"无"}</td></tr> 
<tr><td>备注:</td><td>${abdkOpinion!"无"}</td></tr> 
<tr><td>预警并生成doc存储路径:</td><td>${abdkDocpath!"无"}</td></tr> 
<tr><td>预警并生成html存储路径:</td><td>${abdkHtmlpath!"无"}</td></tr> 
<tr><td>是否提交至全过程异常信息:</td><td>${abdkIstowhole!"无"}</td></tr> 
<tr><td>提交至全过程异常信息监管时间:</td><td>${abdkTowholetime!"无"}</td></tr> 
</table>
