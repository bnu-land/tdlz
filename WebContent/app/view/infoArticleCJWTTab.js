/*
 * File: app/view/infoArticleCJWTTab.js
 *
...
Ext.define('MyApp.view.infoArticleCJWTTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.infoArticleCJWTTab',
                    ...
                    items: [
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDatePub18').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordPub18').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticlePubCJWTStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        //    start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articlePubGrid18');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleRecCJWTStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubCJWTStore');
                                                                    mystore2.load();
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'articleDraftGrid18',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleDraftCJWTStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateDraft18').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordDraft18').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleDraftCJWTStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleDraftGrid18');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftCJWTStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubCJWTStore');
                                                                    mystore2.load();
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateRec18').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordRec18').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleRecCJWTStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        //    start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleRecGrid18');
    ...
    onArticlegridCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        ...
        Ext.getCmp('channelId').setValue('常见问题解答');
