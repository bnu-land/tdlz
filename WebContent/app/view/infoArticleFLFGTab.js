/*
 * File: app/view/infoArticleFLFGTab.js
 *
...
Ext.define('MyApp.view.infoArticleFLFGTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.infoArticleFLFGTab',
                    ...
                    items: [
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDatePub15').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordPub15').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticlePubFLFGStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        //    start:"0",
                                                                        ...
                                                                        if (myform.isValid()) { // make sure the form contains valid data before submitting
                                                                            myform.submit({
                                                                                ...
                                                                                success: function(form, action) {
                                                                                    ...
                                                                                    //}
                                                                                    // );
                                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftFLFGStore'); //获得store对象
                                                                                    mystore.load();
                                                                                    win.close();
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articlePubGrid15');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleRecFLFGStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubFLFGStore');
                                                                    mystore2.load();
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'articleDraftGrid15',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleDraftFLFGStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateDraft15').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordDraft11').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleDraftFLFGStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleDraftGrid15');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftFLFGStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubFLFGStore');
                                                                    mystore2.load();
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateRec15').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordRec15').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleRecFLFGStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        //    start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleRecGrid15');
    ...
    onArticlegridCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        ...
        Ext.getCmp('channelId').setValue('法律法规');
