/*
 * File: app/view/infoArticleBZGFTab.js
 *
...
Ext.define('MyApp.view.infoArticleBZGFTab', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.infoArticleBZGFTab',
                    ...
                    items: [
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDatePub17').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordPub17').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticlePubBZGFStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        //    start:"0",
                                                                        ...
                                                                        if (myform.isValid()) { // make sure the form contains valid data before submitting
                                                                            myform.submit({
                                                                                ...
                                                                                success: function(form, action) {
                                                                                    ...
                                                                                    //}
                                                                                    // );
                                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftBZGFStore'); //获得store对象
                                                                                    mystore.load();
                                                                                    win.close();
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articlePubGrid17');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleRecBZGFStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubBZGFStore');
                                                                    mystore2.load();
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'gridpanel',
                                    id: 'articleDraftGrid17',
                                    collapsible: false,
                                    title: '',
                                    forceFit: true,
                                    store: 'ArticleDraftBZGFStore',
                                    columns: [
                                        {
                                            xtype: 'rownumberer',
                                            width: 47,
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateDraft17').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordDraft17').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleDraftBZGFStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleDraftGrid17');
                                                        ...
                                                        if(record.length === 0){
                                                            ...
                                                            Ext.Ajax.request({
                                                                ...
                                                                success:function(response){
                                                                    ...
                                                                    var mystore = Ext.StoreMgr.get('ArticleDraftBZGFStore');
                                                                    mystore.load();
                                                                    var mystore2 = Ext.StoreMgr.get('ArticlePubBZGFStore');
                                                                    mystore2.load();
                                    ...
                                    dockedItems: [
                                        {
                                            ...
                                            items: [
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var getDate = Ext.util.Format.date(Ext.getCmp('searchDateRec17').getValue(),'Y-m-d');
                                                        var getKeyword = Ext.getCmp('searchKeywordRec17').getValue();
                                                        var mystore=Ext.StoreMgr.get('ArticleRecBZGFStore'); //获得store对象
                                                        //在load事件中添加参数
                                                        //mystore.load(
                                                        //{params:{
                                                        //    start:"0",
                                                ...
                                                },
                                                {
                                                    xtype: 'button',
                                                    handler: function(button, event) {
                                                        var grid = Ext.getCmp('articleRecGrid17');
    ...
    onArticlegridCellClick: function(tableview, td, cellIndex, record, tr, rowIndex, e, eOpts) {
        ...
        Ext.getCmp('channelId').setValue('标准规范');
